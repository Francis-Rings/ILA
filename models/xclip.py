...
def build_model(state_dict: dict, T=8, droppath=0., use_checkpoint=False, logger=None, prompts_alpha=1e-1,
    ...
    frozen_list = ["visual.class_embedding", "visual.positional_embedding", "visual.proj", "visual.conv1.weight",
                   "visual.ln_pre.weight", "visual.ln_pre.bias", "visual.ln_post.weight", "visual.ln_post.bias"]
